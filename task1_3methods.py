...
epsilon_rewards = []
displayer = {'ep':[],'Q-Learning':[],'SARSA':[],'E-SARSA':[]}
...
if index==1:
    ...
    for episode in range(total_episode):
        ...
        if episode % display == 0:
            ...
            displayer['Q-Learning'].append(average_reward)
    ...
    for episode in range(total_episode):
        ...
        if episode % display == 0:
            ...
            total_succ = 0
            displayer['ep'].append(episode)
            displayer['SARSA'].append(average_reward)
    ...
    for episode in range(total_episode):
        ...
        if episode % display == 0:
            ...
            total_succ = 0
            displayer['ep'].append(episode)
            displayer['E-SARSA'].append(average_reward)
...
######## DISPLAY #################
if index==1:
    plt.plot(displayer['ep'], displayer['Q-Learning'], label = 'Q-Learning')
elif index==2:
    plt.plot(displayer['ep'], displayer['SARSA'], label = 'SARSA')
elif index==3:
    plt.plot(displayer['ep'], displayer['E-SARSA'], label = 'E-SARSA')
plt.legend()
